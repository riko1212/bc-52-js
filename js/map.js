...
// const newArr = numbers.map((el, idx, arr) => {
//   const doubleEl = el * 2;
//   return doubleEl;
// });
...
//   // const lengthArr = words.map((el, idx, arr) => {
...
// console.log(getElementsLength(wordsArr)); // [2, 1, 5, 2]
...
// console.table(makeCarsWithDiscount(cars, 0.7));
